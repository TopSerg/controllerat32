...
#define LED1_GPIO_CRM_CLK                CRM_GPIOD_PERIPH_CLOCK

#define LED2_EXT_PIN                     GPIO_PINS_4
#define LED2_EXT_GPIO                    GPIOD
#define LED2_EXT_GPIO_CRM_CLK            CRM_GPIOD_PERIPH_CLOCK
