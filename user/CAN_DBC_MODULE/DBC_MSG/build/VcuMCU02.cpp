...
void VcuMCU02::saturateAdj() {
    ...
    this->VcuMaxSpeed = (uint8_t)SaturateSignalInteger(this->VcuMaxSpeed, 0, 3100);
...
void VcuMCU02::rawPack(dbc_can_tx_message_type* transmitPacket) {
    ...
    PackSignalToCANPacket(transmitPacket, (uint32_t)((this->VcuMaxSpeed - 0) / 100), 43, 5);
...
void VcuMCU02::UpdateGlobalState()
{
    ...
    cpT_VcuMCU02_gstate->VcuMaxSpeed = this->VcuMaxSpeed;
...
void VcuMCU02::ReadGlobalState()
{
    ...
    this->VcuMaxSpeed = cpT_VcuMCU02_gstate->VcuMaxSpeed;
...
c_VcuMCU02 VcuMCU02::toc_VcuMCU02(){
    ...
    out.VcuMaxSpeed = this->VcuMaxSpeed;
...
VcuMCU02::VcuMCU02(c_VcuMCU02* self):VcuMinTorqueLimit(self->VcuMinTorqueLimit), VcuMaxTorqueGradient(self->VcuMaxTorqueGradient), VcuMaxTorqueLimit(self->VcuMaxTorqueLimit), VcuTrqThresholdDampgCtl(self->VcuTrqThresholdDampgCtl), VcuMaxSpeed(self->VcuMaxSpeed), Messagecounter047(self->Messagecounter047), Checksum047(self->Checksum047){};
VcuMCU02::VcuMCU02(dbc_can_rx_message_type* receivedPacket, LocalErrorStats errStats){
    ...
    this->VcuMaxSpeed = (uint8_t)(UnpackSignalFromCANPacket(receivedPacket, 43, 5) * 100 + 0);
