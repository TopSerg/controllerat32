...
#ifndef RTW_HEADER_Position_Observer_h_
#define RTW_HEADER_Position_Observer_h_
...
extern void Position_Observer(const Observer_st *Observer_in, Observer_st
  *Observer_out);

#endif                                 /* RTW_HEADER_Position_Observer_h_ */
