...
typedef struct {
    ...
    OD_obj_var_t o_2000_analogValue;
    OD_obj_var_t o_21FF_magicValue;
    OD_obj_record_t o_2200_netConfig[3];
} ODObjs_t;
...
static CO_PROGMEM ODObjs_t ODObjs = {
    ...
    .o_2000_analogValue = {
        .dataOrig = &OD_RAM.x2000_analogValue,
        .attribute = ODA_SDO_RW | ODA_MB,
        .dataLength = 4
    },
    .o_21FF_magicValue = {
        .dataOrig = &OD_PERSIST_COMM.x21FF_magicValue,
        .attribute = ODA_SDO_RW | ODA_MB,
        .dataLength = 4
    },
    .o_2200_netConfig = {
        {
            .dataOrig = &OD_PERSIST_COMM.x2200_netConfig.highestSub_indexSupported,
            .subIndex = 0,
            .attribute = ODA_SDO_R,
            .dataLength = 1
        },
        {
            .dataOrig = &OD_PERSIST_COMM.x2200_netConfig.canBaud,
            .subIndex = 1,
            .attribute = ODA_SDO_RW | ODA_MB,
            .dataLength = 4
        },
        {
            .dataOrig = &OD_PERSIST_COMM.x2200_netConfig.nodeId,
            .subIndex = 2,
            .attribute = ODA_SDO_RW | ODA_MB,
            .dataLength = 4
        }
...
static OD_ATTR_OD OD_entry_t ODList[] = {
    ...
    {0x2000, 0x01, ODT_VAR, &ODObjs.o_2000_analogValue, NULL},
    {0x21FF, 0x01, ODT_VAR, &ODObjs.o_21FF_magicValue, NULL},
    {0x2200, 0x03, ODT_REC, &ODObjs.o_2200_netConfig, NULL},
